...
# add in different ISO classifications & full county name 
# classify `multiple`, classify `first_only`, classify `last_only`
# `top_cities` = TRUE/FALSE parameter 
# `usa_states` = TRUE/FALSE parameter 
